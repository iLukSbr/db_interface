# Database Interface
MySQL/PostgreSQL database using Flet GUI with credentials save/encryption, database/table selector, table exporter to .csv or .json, query field, .sql dump, .dbml generator and ERD diagram .svg visualizer and exporter.
